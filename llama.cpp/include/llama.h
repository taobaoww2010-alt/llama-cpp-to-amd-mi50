...
extern "C" {
    ...
    // Register a prompt prefix for caching (for prefix caching)
    // This allows reusing KV cache for subsequent requests with the same prompt
    LLAMA_API void llama_memory_register_prefix(
            llama_memory_t mem,
              llama_seq_id seq_id,
